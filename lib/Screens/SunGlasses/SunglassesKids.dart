...
class SunglassKids extends StatefulWidget{
  const SunglassKids({super.key});

  @override
  State<SunglassKids> createState()=> _SunglassKidsState();
}
class _SunglassKidsState extends State<SunglassKids>{
    ...
    return ScreenEntrance(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text("Kids' Sunglasses"),
        ),
        body:Column(
