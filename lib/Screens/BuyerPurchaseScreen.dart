...
class _BuyerPurchaseScreenState extends State<BuyerPurchaseScreen> {
  ...
  Future<void> _prefillFromSavedAddress() async {
    ...
    if (_phone.text.trim().isEmpty) _phone.text = profile.phone ?? '';
    if (_address.text.trim().isEmpty) _address.text = profile.address ?? '';
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      RadioListTile<String>(
                        ...
                        subtitle: const Text('To Pay (when delivered)'),
